...
| 6주차 추천시스템 (12/13) | 5주차 [RNN을 활용한 텍스트 분류 tensorflow](https://www.tensorflow.org/text/tutorials/text_classification_rnn) 튜토리얼 필사<br/>📝[IMDB 영화 리뷰 데이터 감정 분석](https://github.com/wumusill/AI_School/blob/main/Kaggle/RNN/text_classification_rnn_ipynb%EC%9D%98_%EC%82%AC%EB%B3%B8.ipynb) | V |
| 7주차 코사인 유사도 (12/21) | 캐글 추천시스템을 위한 EDA<br/>[🔴Netflix Visualizations, Recommendation, EDA🍿](https://github.com/wumusill/AI_School/blob/main/Kaggle/Netflix/netflix.ipynb) | V |
